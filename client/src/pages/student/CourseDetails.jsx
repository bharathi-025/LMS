...
const CourseDetails = () => {
  ...
  const { calculateRating,calculateNoOfLectures,calculateCourseDuartion,calculateChapterTime,currency,backendUrl,userData, getToken}=useContext(AppContext)
...
<>
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left '>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <p className='pt-4 mdtext-base text-sm' dangerouslySetInnerHTML={{__html:courseData.courseDescription.slice(0,200)}}></p>
                ...
                <div className='pt-8 text-gray-800'>
                  ...
                  <div className='pt-5'>
                    {courseData.courseContent.map((chapter,index)=>(
                      <div className='border border-gary-300 bg-white mb-2 rounded' key={index}>
                        <div onClick={()=>toggleSection(index)} className='flex items-center justify-between px-4 py-3 cursor-pointer select-none'>
                          <div className='flex items-center gap-2'>
                          <img className={`transform transition-transform ${openSections[index]?'rotate-180':''}`} src={assets.down_arrow_icon} alt="aroow" />
      ...
      <img src={courseData.courseThumbnail} alt="" />  
       ...
       <div className='p-5'>
        ...
        <p className='text-red-500' ><span className='font-medium'>5 days left of this price!</span></p>
        </div>
        ...
        <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
                   <div className='flex items-center gap-1'>
                    ...
                    <img  className=''src={assets.star} alt="staricon" />
                    ...
                    <div className='flex items-center gap-1'>
                    <img  className=''src={assets.time_clock_icon} alt="staricon" />
                    ...
                    <div className='flex items-center gap-1'>
                    <img  className=''src={assets.lesson_icon} alt="staricon" />
        ...
        <div className='pt-6'>
          ...
          <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
            ...
            <li>Downloadalble resourses and source code</li>
