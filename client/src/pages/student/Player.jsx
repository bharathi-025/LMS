...
const markLetureAsCompleted=async(lectureId)=>{
  try {
          ...
          <div >
             <YouTube videoId={playerData.lectureUrl.split('/').pop()} 
                     ...
                     <div className='flex justify-between items-center mt-1'>
                      ...
                      <button onClick={()=>markLetureAsCompleted(playerData.lectureId)} className='text-blue-600'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId)? 'completed':'mark complete'}</button>
                     </div>
